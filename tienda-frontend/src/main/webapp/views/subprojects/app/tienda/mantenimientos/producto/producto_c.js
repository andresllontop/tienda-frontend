...
document.addEventListener('DOMContentLoaded', function() {
	...
	if (document.getElementById('FrmProductoModal') != null)
...
function toListProductoC(beanPagination) {
	...
	document.querySelector('#tbodyProductoC').innerHTML += `
	<div class="p-2">
	<a href="javascript:void(0)" id="btnSelecionarNewProductoc" class="card-link">
		Agregar Nuevo <i class="icon icon-arrow-long-right icon-fw"></i> </a>
</div>
	`;
